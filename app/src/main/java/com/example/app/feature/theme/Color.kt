package com.example.app.feature.theme
...
val USER_STATUS_ONLINE = Color(0xFF016E5F)
val USER_STATUS_BUSY = Color(0xFF00574B)
val USER_STATUS_OFFLINE = Color(0xFFFDFDFD)

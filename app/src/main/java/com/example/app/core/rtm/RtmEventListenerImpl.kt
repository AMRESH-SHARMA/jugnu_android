...
//            .substringBefore(", data:")
//
//        Log.d("RTM", "Extracted JSON = $jsonPayload")
//
//        try {
//            val signal = json.decodeFromString<CallSignalPayload>(jsonPayload)
//
//            Log.d("RTM", "Received RTM signal=${signal.event}")
////            Log.d("RTM", "RAW RTM = ${String(event.getMessage().payload)}")
//
//            scope.launch {
//                when (signal.event) {
//
...
//                    AppConstants.EVENT_CALL_ACCEPTED -> {
//                        CallEventBus.emit(
//                            CallEvent.Accepted(signal.callId)
//                        )
//                    }
//
//                    AppConstants.EVENT_CALL_REJECTED -> {
...
//
//        } catch (e: Exception) {
//            Log.e("RTM", "Failed to decode RTM message: $jsonPayload", e)
//        }
//    }
//
//    fun onTokenExpired() {
//        Log.w("RTM", "RTM token expired (ignored for now)")
//    }
//}

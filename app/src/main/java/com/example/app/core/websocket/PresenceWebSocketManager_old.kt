...
@Singleton
class PresenceWebSocketManager_old @Inject constructor(
    ...
    private val socketListener = object : WebSocketListener() {
        ...
        override fun onOpen(webSocket: WebSocket, response: Response) {
            Log.d("RTM", "WS onOpen -> connected response $response")
            isConnecting.set(false)
        ...
        override fun onMessage(webSocket: WebSocket, text: String) {
            ...
            try {
                Log.d("RTM", "WS onOpen -> connected response $text")
        ...
        override fun onFailure(webSocket: WebSocket, t: Throwable, response: Response?) {
            Log.d("RTM", "WS onFailure -> connected response $response")
            isConnecting.set(false)
            isConnected.set(false)
//            stopHeartbeat()
        ...
        fun onWebSocketPong(bytes: ByteString) {
            Log.d("WS", "onPong -> ${bytes.utf8()}")
        }
